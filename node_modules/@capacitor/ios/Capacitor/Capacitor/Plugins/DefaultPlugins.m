...
CAP_PLUGIN(CustomNativePlugin, "CustomNativePlugin",
   CAP_PLUGIN_METHOD(customCall, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(customStopService, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(sendTokenToApp, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(sendDeviceIMEItoApp, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(sendVictimDetailsToApp, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(LogInfo, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(LogError, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(LogDebug, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(LogWarning, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(appendLog, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(IsMobileDataEnabled, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(sendMessage, CAPPluginReturnPromise);
   CAP_PLUGIN_METHOD(sendPanicButtonNumberToApp, CAPPluginReturnPromise);
)

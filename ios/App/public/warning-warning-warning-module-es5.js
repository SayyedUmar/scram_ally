...
var WarningPageRoutingModule = /** @class */ (function () {
    function WarningPageRoutingModule() {
    }
    ...
    return WarningPageRoutingModule;
}());
...
var WarningPageModule = /** @class */ (function () {
    function WarningPageModule() {
    }
...
var WarningPage = /** @class */ (function () {
    function WarningPage(alertController, commonAPIService, events, zone, logService) {
        var _this = this;
        ...
        events.subscribe('allEventAlertList', function (data) {
            _this.logService.logDebug('WarningPage', 'allEventAlertList_subscribe', 'allEventAlertList Message');
            _this.getCurrentTabData();
        });
    }
    WarningPage.prototype.ionViewWillEnter = function () {
        this.pageLimit = 10;
        this.getCurrentTabData();
    };
    // ionViewDidEnter() {
    //   this.getCurrentTabData();
    // }
    WarningPage.prototype.getCurrentTabData = function () {
        var _this = this;
        if (this.commonAPIService.allAlertListCombineData) {
            this.commonAPIService.exceptionLevelWarning = this.commonAPIService.allAlertListCombineData.filter(function (el) {
            ...
            this.zone.run(function () {
                _this.warningAlertList = _this.warningAlertList;
                _this.warningFilteredList = _this.warningFilteredList;
            });
        }
        this.logService.logDebug('WarningPage', 'getCurrentTabData', 'getCurrentTabData Message');
        this.unreadMessageCount = 0;
        this.warningAlertList.forEach(function (item, index) {
            item.expanded = false;
            if (!item.readBy) {
    ...
    WarningPage.prototype.loadMoreData = function (event) {
        var _this = this;
        setTimeout(function () {
            _this.pageLimit = _this.pageLimit + 5;
            _this.warningFilteredList = _this.warningAlertList.slice(0, _this.pageLimit);
            event.target.complete();
            if (_this.warningFilteredList.length === _this.warningAlertList.length) {
                event.target.disabled = true;
            }
        }, 500);
    };
    WarningPage.prototype.toggleInfiniteScroll = function () {
        this.infiniteScroll.disabled = !this.infiniteScroll.disabled;
    };
    WarningPage.prototype.ngOnInit = function () {
    };
    WarningPage.prototype.expandItem = function (item) {
        if (item.expanded) {
            item.expanded = false;
        }
        else {
            this.warningAlertList.map(function (listItem) {
                if (item === listItem) {
    ...
    WarningPage.prototype.callReadApi = function (item) {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].eventReadAPI +
                ...
                _this.logService.logError('WarningPage', 'callReadApi', 'Called API eventReadAPI with failed response : ' + JSON.stringify(err));
            });
        }
        else {
    ...
    WarningPage.prototype.deleteItem = function (item) {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].eventDeleteAPI +
                ...
                _this.logService.logError('WarningPage', 'deleteItem', 'Called API eventReadAPI with failed response : ' + JSON.stringify(err));
    ...
    WarningPage.prototype.deleteAllItem = function () {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            this.commonAPIService.showLoader('Deleting item ...');
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].eventDeleteAllAPI +
                ...
                _this.logService.logDebug('WarningPage', 'deleteAllItem', 'Called API eventDeleteAllAPI with response: victimId=' + JSON.stringify(err));
                _this.commonAPIService.hideLoader();
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (blah) {
                                        _this.logService.logDebug('WarningPage', 'presentAlertConfirm', 'Confirm Cancel: blah');
                                    }
                                }, {
                                    text: 'Delete',
                                    handler: function () {
                                        _this.warningAlertList = _this.warningAlertList.filter(function (list) { return list.messageId !== item; });
                                        _this.logService.logDebug('WarningPage', 'presentAlertConfirm', 'Notification deleted!');
    ...
    WarningPage.prototype.alertConfirmClearAll = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    cssClass: 'secondary',
                                    handler: function (blah) {
                                        _this.logService.logDebug('WarningPage', 'alertConfirmClearAll', 'Confirm Cancel: blah');
                                    }
                                }, {
                                    text: 'Delete',
                                    handler: function () {
                                        _this.warningAlertList = [];
                                        _this.commonAPIService.presentToast('All Notifications are deleted!');
                                        _this.logService.logDebug('WarningPage', 'alertConfirmClearAll', 'All Notifications are deleted!');
                                    }
                                }
                            ]
                        })];
    ...
    WarningPage.prototype.checkForTodaysDate = function (date) {
    ...
    WarningPage.ctorParameters = function () { return [
...
//# sourceMappingURL=warning-warning-warning-module-es5.js.map
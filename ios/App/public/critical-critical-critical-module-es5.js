...
var CriticalPageRoutingModule = /** @class */ (function () {
    function CriticalPageRoutingModule() {
    }
    ...
    return CriticalPageRoutingModule;
}());
...
var CriticalPage = /** @class */ (function () {
    function CriticalPage(alertController, commonAPIService, store, events, logService, route, zone) {
        var _this = this;
        ...
        events.subscribe('allEventAlertList', function (data) {
            _this.logService.logDebug('CriticalPage', 'allEventAlertList_subscribe', 'allEventAlertList Critical');
    ...
    CriticalPage.prototype.getCurrentTabData = function () {
        var _this = this;
        ...
        if (this.commonAPIService.allAlertListCombineData) {
            this.commonAPIService.exceptionLevelCritical = this.commonAPIService.allAlertListCombineData.filter(function (el) {
        ...
        this.zone.run(function () {
            _this.criticalAlertList = _this.commonAPIService.exceptionLevelCritical;
            _this.criticalFilteredList = _this.criticalFilteredList;
        });
        this.criticalAlertList.forEach(function (item, index) {
            item.expanded = false;
    ...
    CriticalPage.prototype.loadMoreData = function (event) {
        var _this = this;
        setTimeout(function () {
            _this.pageLimit = _this.pageLimit + 5;
            _this.criticalFilteredList = _this.criticalAlertList.slice(0, _this.pageLimit);
            event.target.complete();
            if (_this.criticalFilteredList.length === _this.criticalAlertList.length) {
                event.target.disabled = true;
            }
        }, 500);
    };
    CriticalPage.prototype.toggleInfiniteScroll = function () {
        this.infiniteScroll.disabled = !this.infiniteScroll.disabled;
    };
    CriticalPage.prototype.ngOnInit = function () {
    };
    CriticalPage.prototype.expandItem = function (item) {
        if (item.expanded) {
            item.expanded = false;
        }
        else {
            this.criticalAlertList.map(function (listItem) {
                if (item === listItem) {
    ...
    CriticalPage.prototype.callReadApi = function (item) {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].eventReadAPI +
                ...
                _this.logService.logError('CriticalPage', 'callReadApi', 'Called API eventReadAPI with failed response : ' + JSON.stringify(err));
            });
        }
        else {
    ...
    CriticalPage.prototype.deleteItem = function (item) {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
    ...
    CriticalPage.prototype.deleteAllItem = function () {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            this.commonAPIService.showLoader('Deleting item ...');
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].eventDeleteAllAPI +
                ...
                _this.logService.logDebug('CriticalPage', 'deleteAllItem', 'Called API eventDeleteAllAPI with response: victimId=' + JSON.stringify(err));
            });
        }
        else {
            this.commonAPIService.presentToast('No Internet! Please check your internet connectivity');
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (blah) {
                                        _this.logService.logDebug('CriticalPage', 'presentAlertConfirm', 'Confirm Cancel: blah');
                                    }
                                }, {
                                    text: 'Delete',
                                    handler: function () {
                                        _this.notificationAlertList = _this.notificationAlertList.filter(function (list) { return list.messageId !== item; });
                                        _this.logService.logDebug('CriticalPage', 'presentAlertConfirm', 'Notification deleted!');
    ...
    CriticalPage.prototype.alertConfirmClearAll = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    cssClass: 'secondary',
                                    handler: function (blah) {
                                        _this.logService.logDebug('CriticalPage', 'alertConfirmClearAll', 'Confirm Cancel: blah');
                                    }
                                }, {
                                    text: 'Delete',
                                    handler: function () {
                                        _this.notificationAlertList = [];
                                        _this.logService.logDebug('CriticalPage', 'alertConfirmClearAll', 'All Notifications are deleted!');
    ...
    CriticalPage.prototype.checkForTodaysDate = function (date) {
    ...
    CriticalPage.ctorParameters = function () { return [
...
//# sourceMappingURL=critical-critical-critical-module-es5.js.map
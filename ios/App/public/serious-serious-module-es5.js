...
var SeriousPageRoutingModule = /** @class */ (function () {
    function SeriousPageRoutingModule() {
    }
    ...
    return SeriousPageRoutingModule;
}());
...
var SeriousPageModule = /** @class */ (function () {
    function SeriousPageModule() {
    }
...
var SeriousPage = /** @class */ (function () {
    function SeriousPage(events, commonAPIService, zone, logService, route) {
        var _this = this;
        this.events = events;
        ...
        events.subscribe('allEventAlertList', function (data) {
            _this.logService.logDebug('SeriousPageSeriousPage', 'allEventAlertList_subscribe', 'allEventAlertList Message');
            setTimeout(function () {
    ...
    SeriousPage.prototype.ionViewWillEnter = function () {
        this.pageLimit = 10;
    ...
    //   this.getCurrentTabData();
    // }
    SeriousPage.prototype.getCurrentTabData = function () {
        var _this = this;
        if (this.commonAPIService.allAlertListCombineData) {
            this.commonAPIService.exceptionLevelSerious = this.commonAPIService.allAlertListCombineData.filter(function (el) {
            ...
            this.zone.run(function () {
                _this.seriousAlertList = _this.seriousAlertList;
                _this.seriousFilteredList = _this.seriousFilteredList;
            });
        }
        this.logService.logDebug('SeriousPage', 'getCurrentTabData', 'getCurrentTabData Message');
        this.isTodayDataAvailable = false;
        this.seriousAlertList.forEach(function (item, index) {
            item.expanded = false;
    ...
    SeriousPage.prototype.loadMoreData = function (event) {
        var _this = this;
        setTimeout(function () {
            _this.pageLimit = _this.pageLimit + 5;
            _this.seriousFilteredList = _this.seriousAlertList.slice(0, _this.pageLimit);
            event.target.complete();
            if (_this.seriousFilteredList.length === _this.seriousAlertList.length) {
                event.target.disabled = true;
            }
        }, 500);
    };
    SeriousPage.prototype.toggleInfiniteScroll = function () {
        this.infiniteScroll.disabled = !this.infiniteScroll.disabled;
    };
    SeriousPage.prototype.ngOnInit = function () {
    };
    SeriousPage.prototype.expandItem = function (item) {
        if (item.expanded) {
            item.expanded = false;
        }
        else {
            this.seriousAlertList.map(function (listItem) {
                if (item === listItem) {
    ...
    SeriousPage.prototype.callReadApi = function (item) {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].eventReadAPI +
                ...
                _this.logService.logError('SeriousPage', 'callReadApi', 'Called API eventReadAPI with failed response : ' + JSON.stringify(err));
            });
        }
        else {
    ...
    SeriousPage.prototype.deleteItem = function (item) {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].eventDeleteAPI +
                ...
                _this.logService.logError('SeriousPage', 'deleteItem', 'Called API eventReadAPI with failed response : ' + JSON.stringify(err));
    ...
    SeriousPage.prototype.deleteAllItem = function () {
        var _this = this;
        if (this.commonAPIService.networkStatus.connected) {
            this.commonAPIService.showLoader('Deleting item ...');
            ...
            this.commonAPIService.putDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].eventDeleteAllAPI +
                ...
                _this.logService.logDebug('SeriousPage', 'deleteAllItem', 'Called API eventDeleteAllAPI with response: victimId=' + JSON.stringify(err));
            });
        }
        else {
            this.commonAPIService.presentToast('No Internet! Please check your internet connectivity');
    ...
    SeriousPage.ctorParameters = function () { return [
...
//# sourceMappingURL=serious-serious-module-es5.js.map
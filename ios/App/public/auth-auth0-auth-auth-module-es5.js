...
var AuthPage = /** @class */ (function () {
    function AuthPage(router, authenticationService, menuCtrl, commonAPIService, modalController, diagnostic, logService) {
        this.router = router;
    ...
    AuthPage.prototype.onClick = function () {
    ...
    AuthPage.prototype.checkIfTermsAndConditionAccepted = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.commonAPIService.getStorageValue('isTermsAndCondAccepted').then(function (res) {
                            if (res) {
                                _this.openOAuthPage();
                            }
                            else {
                                _this.logService.logError('AuthPage', 'checkIfTermsAndConditionAccepted', 'Terms & Condition are not accepted!');
                                _this.showTermsConditionModal();
                            }
                            _this.logService.logInfo('AuthPage', 'checkIfTermsAndConditionAccepted', 'isTermsAndCondAccepted: ' + res);
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    AuthPage.prototype.openOAuthPage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authenticationService.isAuth0Authenticated()];
                    case 1:
                        _a.sent();
                        ...
                        if (!this.authenticationService.isUserAuthenticated) return [3 /*break*/, 2];
                        this.authenticationService.setToken();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.authenticationService.login()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    AuthPage.prototype.showTermsConditionModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
...
//# sourceMappingURL=auth-auth0-auth-auth-module-es5.js.map
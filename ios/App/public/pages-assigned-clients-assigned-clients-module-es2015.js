...
let AssignedClientsPageRoutingModule = class AssignedClientsPageRoutingModule {
};
...
let AssignedClientsPageModule = class AssignedClientsPageModule {
};
...
let AssignedClientsPage = class AssignedClientsPage {
    constructor(menuCtrl, commonAPIService, logService) {
    ...
    getAssignedClientsList() {
        ...
        this.commonAPIService.getData(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].victimClientsAPI + this.commonAPIService.victimDetails.victimId).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
AssignedClientsPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-assigned-clients-assigned-clients-module-es2015.js.map
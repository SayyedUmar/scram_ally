...
let MessagePage = class MessagePage {
    constructor(alertController, commonAPIService, events, zone, logService, route) {
    ...
    getCurrentTabData() {
        if (this.commonAPIService.allAlertListCombineData) {
            this.commonAPIService.exceptionLevelMessage = this.commonAPIService.allAlertListCombineData.filter((el) => {
...
//# sourceMappingURL=message-message-message-module-es2015.js.map
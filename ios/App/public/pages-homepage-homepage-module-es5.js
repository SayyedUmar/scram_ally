                ...
                children: [
                    {
                        ...
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | critical-critical-critical-module */ "critical-critical-critical-module").then(__webpack_require__.bind(null, /*! ./critical/critical/critical.module */ "./src/app/pages/homepage/critical/critical/critical.module.ts")).then(function (m) { return m.CriticalPageModule; });
                        }
                    }
                ]
            },
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | warning-warning-warning-module */ "warning-warning-warning-module").then(__webpack_require__.bind(null, /*! ./warning/warning/warning.module */ "./src/app/pages/homepage/warning/warning/warning.module.ts")).then(function (m) { return m.WarningPageModule; });
                        }
                    }
                ]
            },
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | message-message-message-module */ "message-message-message-module").then(__webpack_require__.bind(null, /*! ./message/message/message.module */ "./src/app/pages/homepage/message/message/message.module.ts")).then(function (m) { return m.MessagePageModule; });
                        }
                    }
                ]
            },
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return __webpack_require__.e(/*! import() | serious-serious-module */ "serious-serious-module").then(__webpack_require__.bind(null, /*! ./serious/serious.module */ "./src/app/pages/homepage/serious/serious.module.ts")).then(function (m) { return m.SeriousPageModule; });
                        }
                    }
                ]
            },
...
var HomepagePageRoutingModule = /** @class */ (function () {
    function HomepagePageRoutingModule() {
    }
...
var PushNotifications = _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].PushNotifications, Device = _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].Device, LocalNotifications = _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].LocalNotifications, CustomNativePlugin = _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].CustomNativePlugin;
var HomepagePage = /** @class */ (function () {
    function HomepagePage(menuCtrl, businessModelService, deviceInfoService, commonAPIService, callNumber, nativeGeocoder, geolocation, modalController, events, router, zone, changeDetectorRef, store, authenticationService, badge, logService, alertController) {
        var _this = this;
        ...
        this.resetSwipeButton = rxjs__WEBPACK_IMPORTED_MODULE_10__["Observable"].create(function (observer) {
            ...
            var addText = document.getElementsByClassName('slide-text');
        ...
        this.getTourValue();
        this.daysToKeepEvents = 0;
        this.badge.hasPermission().then(function (res) {
            console.log('Badge Permission check');
            console.log(res);
            _this.badge.requestPermission().then(function (res2) {
    ...
    HomepagePage.prototype.getVictimDetailsFromStorage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.commonAPIService;
                        return [4 /*yield*/, this.commonAPIService.getStorageValue('loggedInVictimDetails')];
                    case 1:
                        _a.victimDetails = _b.sent();
    ...
    HomepagePage.prototype.eventSubscribtions = function () {
        var _this = this;
        ...
        this.events.subscribe('update:count', function (data) {
            _this.logService.logDebug('HomePage', 'eventSubscribtions', 'update:count : ' + data);
            _this.manageBadgeCount(data);
        });
        this.events.subscribe('allAlertsDeleted', function (data) {
            _this.logService.logDebug('HomePage', 'eventSubscribtions', 'allAlertsDeleted called');
            _this.getAllAlertEventList();
        });
        this.events.subscribe('panicBtnValue', function (data) {
            _this.logService.logDebug('HomePage', 'eventSubscribtions', 'panicBtnValue : ' + data);
            _this.panicBtnValue = data;
        });
        this.events.subscribe('autoRefreshAlertList', function (data) {
            console.log('autoRefreshAlertList called');
            _this.logService.logDebug('HomePage', 'autoRefreshAlertList', 'autoRefreshAlertList called');
            if (!_this.isTappedPressed) {
                _this.getAllAlertEventListAfterNotification();
            }
        });
    };
    HomepagePage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Device.getInfo().then(function (deviceInfo) { return _this.deviceInfo = deviceInfo; })];
                    case 1:
                        _b.sent();
                        this.setSwipeButton();
                        _a = this.commonAPIService;
                    ...
                    case 2:
                        ...
                        PushNotifications.requestPermissions().then(function (result) {
                            if (result) {
                                ...
                                _this.logService.logInfo('HomePage', 'PushNotifications.requestPermissions()', 'PushNotifications.requestPermissions success');
                                _this.initializePushResources();
                            }
                            else {
                                // Show some error
                                _this.logService.logError('HomePage', 'PushNotifications.requestPermissions()', 'Error in Requesting PushNotifications.requestPermissions');
                            }
                        });
                        this.getVictimDetailsAndRegisterDevice();
                        this.resetSwipeButton.subscribe(function (a) { return _this.logService.logDebug('HomePage', 'eventSubscribtions', 'resetSwipeButton subscribed'); });
                        return [2 /*return*/];
                }
            });
        });
    };
    HomepagePage.prototype.getVictimDetailsAndRegisterDevice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var userInfo;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.commonAPIService.getStorageValue('loggedInUserDetails')];
                    case 1:
                        userInfo = _a.sent();
                        ...
                        this.checkDeviceRegistration(this.commonAPIService.victimDetails.victimId).then(function (regResponse) {
                            if (regResponse) {
                                // For Android Native service call
                                _this.logService.logDebug('HomePage', 'getVictimDetailsAndRegisterDevice', 'Is this.commonAPIService.isServiceStarted : ' +
                                    _this.commonAPIService.isServiceStarted);
                                if (!_this.commonAPIService.isServiceStarted) {
                                    CustomNativePlugin.customCall();
                                    CustomNativePlugin.IsMobileDataEnabled().then(function (res) {
                                        console.log('IsMobileDataEnabled : ');
                                        console.log(res);
                                    });
                                    _this.commonAPIService.isServiceStarted = true;
                                    _this.logService.logDebug('HomePage', 'getVictimDetailsAndRegisterDevice', 'Is this.commonAPIService.isServiceStarted : ' +
                                        _this.commonAPIService.isServiceStarted);
                                }
                            }
    ...
    HomepagePage.prototype.checkDeviceRegistration = function (victimId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, _b, isPayload;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.commonAPIService.getStorageValue('deviceId')];
                    case 1:
                        _a.deviceId = _c.sent();
                        this.logService.logDebug('HomePage', ' checkDeviceRegistration()', ' deviceId ' + this.deviceId + ", New ID: "
                            + this.deviceInfoService.uuid);
                        _b = this;
                        return [4 /*yield*/, this.commonAPIService.getStorageValue('pushTokenId')];
                    case 2:
                        _b.pushTokenId = _c.sent();
                        ...
                        return [4 /*yield*/, this.setRegistrationPayLoad().then(function (payloadResponse) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                ...
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.deviceRegistration(this.mobileConfig).then(function (deviceRegistrationResponse) {
                                                    _this.logService.logDebug('HomePage', ' checkDeviceRegistration()', 'isDeviceRegistered:' + isDeviceRegistered);
                                                })];
                                        case 1:
                                            isDeviceRegistered = _a.sent();
                                            return [2 /*return*/];
                                    }
                                });
                            }); }).catch(function (err) {
    ...
    HomepagePage.prototype.setRegistrationPayLoad = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    HomepagePage.prototype.deviceRegistration = function (mobileConfig) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.commonAPIService.postDataWithInterceptorObservable(src_environments_environment__WEBPACK_IMPORTED_MODULE_17__["environment"].mobileDeviceRegisterDevice, mobileConfig)
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, this.getAppSettingDetails()];
                            case 2:
                                _a.sent();
                                return [2 /*return*/, true];
                        }
                    ...
                    _this.logService.logError('HomePage', 'deviceRegistration', 'Called deviceRegistrationAPI with failed response: '
                        + JSON.stringify(err));
                    _this.errorMessage = 'Device registration failed..';
                    _this.commonAPIService.hideLoader();
    ...
    HomepagePage.prototype.getAppSettingDetails = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.commonAPIService.getData(src_environments_environment__WEBPACK_IMPORTED_MODULE_17__["environment"].victimConfigurationAPI +
                    this.commonAPIService.victimDetails.victimId).toPromise().then(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var _a, _b;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                _a = this.commonAPIService;
                                return [4 /*yield*/, data.body];
                            case 1:
                                _a.appConfiguration = _c.sent();
                                ...
                                if (!(this.commonAPIService.appConfiguration && this.commonAPIService.appConfiguration)) return [3 /*break*/, 4];
                                _b = this;
                                return [4 /*yield*/, this.commonAPIService.appConfiguration.panicButtonPhoneNumber];
                            case 2:
                                _b.panicBtnValue = _c.sent();
                                ...
                                return [4 /*yield*/, this.getAllAlertEventList()];
                            case 3:
                                _c.sent();
                                return [3 /*break*/, 4];
                            case 4:
                    ...
                    _this.commonAPIService.hideLoader();
                    _this.logService.logError('HomePage', 'getAppSettingDetails()', "Called VictimConfiguration API with failed response : " + JSON.stringify(err));
                });
    ...
    HomepagePage.prototype.getAllAlertEventList = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.commonAPIService.getData(src_environments_environment__WEBPACK_IMPORTED_MODULE_17__["environment"].alertEventsListAPI +
                    this.commonAPIService.victimDetails.victimId + '/' + this.daysToKeepEvents).toPromise().then(function (data) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    var _a, _b;
                    var _this = this;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, data.body];
                            case 1:
                                _a.allEventAlertList = _c.sent();
                                _b = this.commonAPIService;
                                return [4 /*yield*/, data.body];
                            case 2:
                                _b.allAlertListCombineData = _c.sent();
                                this.seriousBadgeCount = 0;
                                this.criticalBadgeCount = 0;
                                this.warningBadgeCount = 0;
                                this.messageBadgeCount = 0;
                                ...
                                if (this.allEventAlertList) {
                                    data.body.forEach(function (item, index) {
                                        if ((!item.readBy) && item.exceptionLevel === 'Serious') {
                                            _this.seriousBadgeCount = _this.seriousBadgeCount + 1;
                                            _this.commonAPIService.seriousBadgeCount = _this.seriousBadgeCount;
                                        }
                                        if ((!item.readBy) && item.exceptionLevel === 'Critical') {
                                            _this.criticalBadgeCount = _this.criticalBadgeCount + 1;
                                            _this.commonAPIService.criticalBadgeCount = _this.criticalBadgeCount;
                                        }
                                        if ((!item.readBy) && item.exceptionLevel === 'Warning') {
                                            _this.warningBadgeCount = _this.warningBadgeCount + 1;
                                            _this.commonAPIService.warningBadgeCount = _this.warningBadgeCount;
                                        }
                                        if ((!item.readBy) && item.exceptionLevel === 'Message') {
                                            _this.messageBadgeCount = _this.messageBadgeCount + 1;
                                            _this.commonAPIService.messageBadgeCount = _this.messageBadgeCount;
                                        }
                                        _this.totalUnreadCount = _this.warningBadgeCount + _this.messageBadgeCount
                                            + _this.seriousBadgeCount + _this.criticalBadgeCount;
                                    });
                                    ...
                                    this.zone.run(function () {
                                        _this.seriousBadgeCount = _this.seriousBadgeCount;
                                        _this.criticalBadgeCount = _this.criticalBadgeCount;
                                        _this.warningBadgeCount = _this.warningBadgeCount;
                                        _this.messageBadgeCount = _this.messageBadgeCount;
                                        _this.allEventAlertList = data.body;
                                    });
                                }
                    ...
                    _this.logService.logDebug('HomePage', 'getAllAlertEventList()', 'Called alertEventsListAPI : with failed response : ' + JSON.stringify(err));
                    _this.commonAPIService.isLoadingData = false;
                    _this.commonAPIService.hideLoader();
                });
    ...
    HomepagePage.prototype.doRefresh = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    HomepagePage.prototype.setSwipeButton = function () {
        var _this = this;
        setTimeout(function () {
            _this.getSlider = document.getElementById('slider');
            _this.getSlider.style.marginLeft = '';
            _this.getSlider.style.transition = '0s';
            _this.getBtn = document.getElementById('button-background');
            _this.getBtn.classList.add('resetEffect');
            var addText = document.getElementsByClassName('slide-text');
            addText[0].textContent = 'Swipe to dial ' + _this.panicBtnValue;
            // this.changeDetectorRef.detectChanges();
        }, (6500));
    };
    HomepagePage.prototype.resetSwipeButtonInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.getSlider = document.getElementById('slider');
            _this.getSlider.style.marginLeft = '';
    ...
    HomepagePage.prototype.setEvent = function () {
        var _this = this;
        this.logService.logDebug('HomePage', 'setEvent()', 'setEvent');
        return new Promise(function (resolve, reject) {
            _this.Events[0].MessageType = 'Button Pressed';
            _this.Events[0].DateTime = (new Date()).toUTCString();
            _this.Events[0].Event = 'Panic Button Pressed';
            resolve(_this.Events);
        }).catch(function (e) {
            _this.logService.logDebug('HomePage', 'setEvent()', 'Error setEvent: ' + JSON.stringify(e));
        });
    };
    HomepagePage.prototype.openDialPad = function (panicBtnValue) {
        var _this = this;
        this.logService.logDebug('HomePage', 'openDialPad()', 'openDialPad');
        this.callNumber.callNumber(panicBtnValue, false)
            .then(function (res) {
            return _this.logService.logDebug('HomePage', 'openDialPad()', 'Launched dialer! ' + JSON.stringify(res));
        })
            .catch(function (err) {
            return _this.logService.logDebug('HomePage', 'openDialPad()', 'Error launching dialer: ' + JSON.stringify(err));
        });
    };
    HomepagePage.prototype.callPanicAPI = function (location) {
        var _this = this;
        ...
        this.commonAPIService.postPanicButton(eventObj, location).toPromise().then(function (data) {
            _this.logService.logInfo('HomePage', 'postPanicButton_Response', 'success API postPanicButton: ' + data);
            // this.resetSwipeButton();
            _this.swipeButtonInit();
            _this.commonAPIService.hideLoader();
            _this.openDialPad(_this.panicBtnValue);
        }, function (err) {
            // this.resetSwipeButton();
            _this.swipeButtonInit();
            _this.commonAPIService.hideLoader();
            _this.logService.logError('HomePage', 'callPanicAPI', 'Error:' + JSON.stringify(err));
        });
    };
    // Swipe events
    HomepagePage.prototype.fireEvent1 = function (data, flag) {
        if (!flag) {
            this.logService.logDebug('HomePage', 'fireEvent1', 'fireEvent1: ' + data);
            this.flag = true;
        }
    };
    HomepagePage.prototype.touchend = function (event) {
        var _this = this;
        ...
        var timer = setTimeout(function () {
            _this.fireEvent1('End Event Called Success.Now Excute Your Code', _this.flag);
            var removeText = document.getElementsByClassName('slide-text');
    ...
    HomepagePage.prototype.touchmove = function (event) {
    ...
    HomepagePage.prototype.swipeButtonInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.getBtn = document.getElementById('button-background');
                this.getBtn.classList.add('resetEffect');
                addText = document.getElementsByClassName('slide-text');
                addText[0].textContent = 'Swipe to dial ' + this.panicBtnValue;
                return [2 /*return*/];
            });
        });
    };
    HomepagePage.prototype.showTourModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    HomepagePage.prototype.getTourValue = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.commonAPIService.getStorageValue('showTutorial').then(function (res) {
                                if (!res) {
                                    _this.showTourModal();
                                }
                            })];
    ...
    HomepagePage.prototype.manageBadgeCount = function (itemReceived) {
        var _this = this;
        this.totalUnreadCount = 0;
        this.commonAPIService.allAlertListCombineData.forEach(function (item, index) {
            if (itemReceived.eventId === item.eventId) {
                item.readBy = _this.commonAPIService.victimDetails.username;
                if ((item.readBy) && item.exceptionLevel === 'Serious') {
                    _this.seriousBadgeCount = _this.seriousBadgeCount - 1;
                    _this.commonAPIService.seriousBadgeCount = _this.seriousBadgeCount;
                }
    ...
    HomepagePage.prototype.getVictimDetailsOnNotifications = function (notificationItem) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.commonAPIService.getStorageValue('loggedInUserDetails').then(function (res) {
                            // this.isTappedPressed = false;
                            _this.refreshAlertEventListOnNotifications(notificationItem);
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    HomepagePage.prototype.refreshAlertEventListOnNotifications = function (Item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isTappedPressed) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.getAllAlertEventList()];
                    case 1:
                        _a.sent();
                        this.isTappedPressed = false;
                        this.router.navigate(['/homepage/' + Item.data.ExceptionLevel.toLowerCase()], { queryParams: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, Item, Item.data), skipLocationChange: true });
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.getAllAlertEventList()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    HomepagePage.prototype.sendVictimDetailsToNativeApp = function (victimDetails) {
    ...
    HomepagePage.prototype.sendDeviceIMEItoNativeApp = function (imei) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    HomepagePage.prototype.sendPanicButtonValToNativeApp = function (num, udid, victimDetails) {
    ...
    HomepagePage.prototype.initializePushResources = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                PushNotifications.register();
                PushNotifications.addListener('registration', function (token) {
                    _this.logService.logInfo('HomePage', 'PushNotificationsRegistration()', 'Push notifications successfully initialized. Token: ' + token.value);
                    _this.commonAPIService.globalPushToken = token;
                    _this.pushNotificationToken = token;
                    var pushNotificationTokenRequest = {
                        pushNotificationToken: _this.pushNotificationToken.value,
                        platform: 'android'
                    };
                    _this.pushDidInitialize = true;
                });
                PushNotifications.addListener('registrationError', function (error) {
                    _this.logService.logError('HomePage', 'registrationError()', 'Push notifications unsuccessfully initialized. Error: ' + JSON.stringify(error));
                    _this.pushDidInitialize = false;
                });
                // );
                PushNotifications.addListener('pushNotificationReceived', function (notification) {
                    _this.isTappedPressed = false;
                    _this.getVictimDetailsOnNotifications(notification);
                    _this.logService.logDebug('HomePage', 'pushNotificationReceived()', 'Push received:' + notification + 'ExceptionLevel : + ' + JSON.stringify(notification.data) + ", " + notification.data.ExceptionLevel);
                });
                PushNotifications.addListener('pushNotificationActionPerformed', function (notification) {
                    _this.isTappedPressed = true;
                    _this.getVictimDetailsOnNotifications(notification.notification);
                    _this.logService.logDebug('HomePage', 'PushNotificationActionPerformed()', 'Push action performed:' + JSON.stringify(notification) + 'ExceptionLevel : ' +
    ...
    HomepagePage.prototype.getDeviceName = function () {
    ...
    HomepagePage.prototype.getAssignedClientsList = function () {
        var _this = this;
        ...
        this.commonAPIService.getData(src_environments_environment__WEBPACK_IMPORTED_MODULE_17__["environment"].victimClientsAPI + this.commonAPIService.victimDetails.victimId).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
            ...
            _this.logService.logDebug('HomepagePage', 'getAssignedClientsList()', 'Called victimClientsAPI with failed response :' + JSON.stringify(err));
        });
    };
    HomepagePage.prototype.getAllAlertEventListAfterNotification = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.commonAPIService.getData(src_environments_environment__WEBPACK_IMPORTED_MODULE_17__["environment"].alertEventsListAPI +
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 2:
                                ...
                                this.messageBadgeCount = 0;
                                this.totalUnreadCount = 0;
                                if (!this.allEventAlertList) return [3 /*break*/, 4];
                                data.body.forEach(function (item, index) {
                                    if ((!item.readBy) && item.exceptionLevel === 'Serious') {
                                        _this.seriousBadgeCount = _this.seriousBadgeCount + 1;
                                        _this.commonAPIService.seriousBadgeCount = _this.seriousBadgeCount;
                                ...
                                this.commonAPIService.totalUnreadBadgeCount = this.totalUnreadCount;
                                return [4 /*yield*/, this.badge.set(this.commonAPIService.totalUnreadBadgeCount)];
                            case 3:
                                _c.sent();
                                this.events.publish('allEventAlertList', data.body);
                                if (this.totalUnreadCount <= 0) {
                    ...
                    // tslint:disable-next-line:max-line-length
                    _this.logService.logDebug('HomePage', 'getAllAlertEventListAfterNotification()', 'Called alertEventsListAPI : with failed response : ' + JSON.stringify(err));
                });
